...
export default class AnswerView extends Component<Answer,any> {
    ...
    render(): JSXElement {
        return (
            <View style={{flexDirection:'column',elevation:1,backgroundColor:'#ffffff',marginBottom:8}}>
                <TouchableHighlight underlayColor="#d9d9d944" onPress={this.onPress.bind(this)}>
                    <View style={{flexDirection:'column',padding:16}}>
                        <View style={{flexDirection:'row',alignSelf:'stretch',marginBottom:12}}>
                            ...
                            <Text
                                style={{color:'#3349578A',fontSize:14}}>{getRelativeTime(this.props.created_time)}</Text>
                        </View>
